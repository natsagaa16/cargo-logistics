// frontend/src/components/TopBar1.js
import React, { useState, useEffect } from 'react';
import { FaBars, FaUser, FaSignOutAlt, FaBell, FaChevronDown } from 'react-icons/fa';
...
const TopBar = ({ toggleSidebar }) => {
  ...
  // Mock notifications
  const notifications = [
    { id: 1, message: "Шинэ захиалга ирсэн", time: "5 минутын өмнө", unread: true },
    { id: 2, message: "Агуулах хангалт дууссан", time: "1 цагийн өмнө", unread: true },
            ...
            {showUserMenu && (
              <div className="profile-dropdown">
                ...
                <div className="profile-dropdown-header">
                  ...
                  <div>
                    <div className="profile-dropdown-name">Админ хэрэглэгч</div>
                    <div className="profile-dropdown-email">admin@jimgun.mn</div>
                  </div>
                </div>
